...
/***/ function(module, exports, __webpack_require__) {
	...
	var _habitListing = __webpack_require__(161);
	...
	var userId = 123;
	_reactDom2.default.render(_react2.default.createElement(_habitListing2.default, { source: "/health1/server/habit/user",
	  userid: userId
	}), document.getElementById('habit_listing'));
	_reactDom2.default.render(_react2.default.createElement(_addingHabit2.default, null), document.getElementById('new_habit_popup'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HabitModel = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      "div",
	      null,
	      _react2.default.createElement(NavHabit, { dataList: this.state.data })
	    );
	  }
	});
	...
	var NavHabit = _react2.default.createClass({
	  ...
	  handleCurrentHabit: function handleCurrentHabit(data) {
	    this.setState({
	      currentHabit: data
	    });
	  },
	  render: function render() {
	    return _react2.default.createElement(
	      "div",
	      null,
	      _react2.default.createElement(HabitList, {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "ul",
	          { id: "habit_list" },
	          newList.map(function (dataRow, i) {
	            //mapping each habit that need to display to a li element, and whenever each item is clicked it will trigger a modal
	            if (dataRow != undefined) {
	              console.log("add habits display");
	              return _react2.default.createElement(
	                "li",
	                { className: "habits_display", key: i, onClick: this.handleCurrentHabit.bind(this, dataRow), href: "#current_habit_modal" },
	                dataRow.description
	              );
	            } else {
	              return _react2.default.createElement(
	...
	var PageNav = _react2.default.createClass({
	  ...
	  handleClicks: function handleClicks(page) {
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      "div",
	      { id: "habit_listing_nav" },
	      _react2.default.createElement(
	        "ul",
	        { className: "pagination text-center", role: "navigation", "aria-label": "Pagination" },
	        _react2.default.createElement(
	          "li",
	          { className: prevClassName, onClick: this.handleClicks.bind(this, -1) },
	          this.props.currentPageNum == 1 ? "Previous" : _react2.default.createElement(
	            "a",
	            null,
	            "Previous"
	          )
	...
	*/
	...
	var AddingNewHabit = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      "div",
	      { id: "habit_input_modal" },
	      _react2.default.createElement(
	        "div",
	        { id: "instruction_header" },
	        _react2.default.createElement(
	          "div",
	          { className: "success progress", role: "progressbar", tabIndex: 0, "aria-valuenow": 25, "aria-valuemin": 0, "aria-valuetext": "25 percent", "aria-valuemax": 100 },
	          _react2.default.createElement(ProgressBar, { progress: this.state.progress })
	        ),
	        _react2.default.createElement(
	          "div",
	          ...
	          _react2.default.createElement(
	            "div",
	            { id: "new_habit_navigate", style: { float: 'right' } },
	            _react2.default.createElement(NaviForm, { onUserNavi: this.handleUserClick,
	              progress: this.state.progress
	            })
	          )
	        )
	      ),
	      _react2.default.createElement(NewHabitForm, { progress: this.state.progress })
	    );
	  }
	...
	var NaviForm = _react2.default.createClass({
	  ...
	  userClick: function userClick(direction) {
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "button",
	        { style: { marginRight: '10%' }, onClick: this.userClick.bind(this, -1) },
	        this.props.progress != 0 ? "Previous" : _react2.default.createElement(
	          "div",
	          { style: { color: '#95a5a6' } },
	          "Previous"
	        )
	      ...
	      _react2.default.createElement(
	        "button",
	        { onClick: this.userClick.bind(this, 1) },
	        this.props.progress != 100 ? "Next" : _react2.default.createElement(
	          "div",
	          { style: { color: '#95a5a6' } },
	          "Next"
	        )
	...
	var ProgressBar = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement("div", { className: "progress-meter", style: { width: progress + '%' } });
	  }
	});

	var NewHabitForm = _react2.default.createClass({
	  displayName: "NewHabitForm",

	  getInitialState: function getInitialState() {
	    return {
	      questions: ["What is your new habit description?", "how often do you plan to do this?", "which days of the week?", "When is/was your start day", "You are done! hit submit and start your development"]
	    };
	  },
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      }) : this.props.progress == 100 ? _react2.default.createElement(SubmitNewHabit, null) : console.log("error")
	    );
	  }
	});

	var SubmitNewHabit = _react2.default.createClass({
	  displayName: "SubmitNewHabit",

	  render: function render() {
	    console.log("came");
	    return _react2.default.createElement(
	      "button",
	      { onClick: _HabitCreationModel2.default.updateHabitListing.bind(_HabitCreationModel2.default) },
	      " click me "
	    );
	  }
	...
	var NewHabitInputBox = _react2.default.createClass({
	  ...
	  userInput: function userInput(event) {
	    var setValue = this.props.setValue.bind(_HabitCreationModel2.default);
	    setValue(event.target.value);
	  },
	  render: function render() {
	    var getValue = this.props.getValue.bind(_HabitCreationModel2.default);
	    return _react2.default.createElement(
	      "fieldset",
	      { className: "fieldset" },
	      _react2.default.createElement(
	...
	var FrequencyForm = _react2.default.createClass({
	  displayName: "FrequencyForm",

	  userInput: function userInput(selection) {
	    _HabitCreationModel2.default.addFrequency(selection);
	  },
	...
	var DaysForm = _react2.default.createClass({
	  displayName: "DaysForm",

	  userInput: function userInput(day) {
	    console.log("clicked on" + day);
	    _HabitCreationModel2.default.addDays(day);
	  },
	...
	var QuestionDisplay = _react2.default.createClass({
	  displayName: "QuestionDisplay",
	  ...
	  render: function render() {
	    ...
	    if (this.props.questionNum == 2) {
	      ...
	      //for all other questions, we add nothing to the display
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	var formModel = {
	  ...
	  addDescription: function addDescription(description) {
	    this.newHabitInfo.description = description;
	  },
	  addFrequency: function addFrequency(selection) {
	    this.newHabitInfo.frequency = selection;
	  },

	  addStartDay: function addStartDay(startDay) {
	  ...
	  */
	  addDays: function addDays(day) {
	    ...
	    for (var i = 0; i < length; i++) {
	      if (this.newHabitInfo.days[i] == day) {
	        //the changed checkbox existed in array, so this mean the user unchecked the box, so we take it out of array
	  ...
	  updateHabitListing: function updateHabitListing() {
	    var temp;
	    if (sessionStorage.userid) {
